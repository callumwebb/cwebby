...
A confusion matrix is essentially a way to visualise the accuracy of a set of labels by counting the numbers in each category.
Drag the berries between the two groups to see how this works:

<figure class = "confusionMatrix"></figure>
