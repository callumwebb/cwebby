...
<figure class = "berryMatrix" style = "max-width:240px"></figure>
<hr/>
...
Any set of predictions where the actual class is known can be shown on an ROC plot as a point -- the x axis is simply the false positive rate, and the y axis is the true positive rate. This is a nice visual way to summarise one part of the confusion matrix. Below we're showing the true and false positive rate of the current arrangement of labels from before as a point on the plot.

<figure class = "rocPoint" style = "max-width:240px"></figure>
